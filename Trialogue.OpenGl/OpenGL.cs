...
namespace Trialogue.OpenGl
{
    ...
    public static unsafe partial class GL
    {
        ...
        ///     <para>GL.FRONT, GL.BACK, and GL.FRONT_AND_BACK are accepted. The initial value is GL.BACK.</para>
        /// </param>
        /// <remarks>If mode is GL.FRONT_AND_BACK, no facets are drawn, but other primitives such as points and lines are drawn.</remarks>
        ...
        ///     <para>GL.CW and GL.CCW are accepted. The initial value is GL.CCW.</para>
        /// </param>
        ...
        ///     <para>
        ///         GL.LINE_SMOOTH_HINT, GL.POLYGON_SMOOTH_HINT, GL.TEXTURE_COMPRESSION_HINT, and
        ...
        /// </summary>
        /// <param name="face">
        ///     Specifies the polygons that mode applies to. Must be GL.FRONT_AND_BACK for front- and back-facing
        ///     polygons
        /// </param>
        /// <param name="mode">
        ///     Specifies how polygons will be rasterized.
        ///     <para>Accepted values are GL.POINT, GL.LINE, and GL.FILL.</para>
        ...
        ///     <para>The three masks are GL.COLOR_BUFFER_BIT, GL.DEPTH_BUFFER_BIT,, and GL.STENCIL_BUFFER_BIT.</para>
        /// </param>
        ...
        /// </summary>
        /// <param name="name">
        ///     Specifies a symbolic constant, one of GL.VENDOR, GL.RENDERER, GL.VERSION, or
        ...
        /// </summary>
        /// <param name="name">
        ///     Specifies a symbolic constant, one of GL.VENDOR, GL.RENDERER, GL.VERSION, GL.SHADING_LANGUAGE_VERSION, or GL.EXTENSIONS.
        /// </param>
        ...
        ///     into memory: GL.PACK_ALIGNMENT. The other affects the unpacking of pixel data from memory: GL.UNPACK_ALIGNMENT.
        /// </param>
        ...
        ///     <para>
        ///         Must be GL.STREAM_DRAW, GL.STREAM_READ, GL.STREAM_COPY, GL.STATIC_DRAW, GL.STATIC_READ, GL.STATIC_COPY,
        ///         GL.DYNAMIC_DRAW, GL.DYNAMIC_READ, or GL.DYNAMIC_COPY.
        ///     </para>
        ///     .
        /// </param>
        ...
        /// </summary>
        /// <param name="target">
        ///     Specifies the target texture of the active texture unit, which must be either GL.TEXTURE_2D or
        ///     GL.TEXTURE_CUBE_MAP.
        /// </param>
        /// <param name="paramName">
        ///     Specifies the symbolic name of a single-valued texture parameter. <paramref name="paramName" /> can be
        ///     one of the following: GL.TEXTURE_MIN_FILTER, GL.TEXTURE_MAG_FILTER, GL.TEXTURE_WRAP_S, or GL.TEXTURE_WRAP_T.
        /// </param>
        ...
        ///     <para>Must be one of GL.UNSIGNED_BYTE, GL.UNSIGNED_SHORT, or GL.UNSIGNED_INT.</para>
        /// </param>
        ...
        /// <param name="format">Specifies the format of the pixel data.<para>The following symbolic values are accepted: GL.STENCIL_INDEX, GL.DEPTH_COMPONENT, GL.DEPTH_STENCIL, GL.RED, GL.GREEN, GL.BLUE, GL.RGB, GL.BGR, GL.RGBA, and GL.BGRA.</para></param>
        ...
        /// </summary>
        /// <param name="target">
        ///     Specifies the target type of query object established between <see cref="BeginQuery" /> and the subsequent
        ///     <see cref="EndQuery" />.
        ///     <para>
        ///         Must be one of GL.SAMPLES_PASSED, GL.ANY_SAMPLES_PASSED, GL.ANY_SAMPLES_PASSED_CONSERVATIVE,
        ...
        ///     <para>Must be GL.FUNC_ADD, GL.FUNC_SUBTRACT, GL.FUNC_REVERSE_SUBTRACT, GL.MIN, GL.MAX.</para>
        /// </param>
        ...
        ///     <para>Three symbolic constants are valid: GL.FRONT, GL.BACK, and GL.FRONT_AND_BACK.</para>
        /// </param>
        /// <param name="func">
        ///     Specifies the test function.
        ///     <para>
        ///         Eight symbolic constants are valid: GL.NEVER, GL.LESS, GL.LEQUAL, GL.GREATER, GL.GEQUAL, GL.EQUAL,
        ///         GL.NOTEQUAL, and GL.ALWAYS. The initial value is GL.ALWAYS
        ///     </para>
        ///     .
        /// </param>
        ...
        ///     <para>
        ///         Eight symbolic constants are accepted: GL.KEEP, GL.ZERO, GL.REPLACE, GL.INCR, GL.INCR_WRAP, GL.DECR,
        ///         GL.DECR_WRAP, and GL.INVERT. The initial value is GL.KEEP.
        ///     </para>
        /// </param>
        /// <param name="dpfail">
        ...
        ///     <para>The initial value is GL.KEEP.</para>
        /// </param>
        /// <param name="dppass">
        ///     Specifies the stencil action when both the stencil test and the depth test pass, or when the
        ...
        ///     <para>Must be GL.TIMEOUT_IGNORED.</para>
        /// </param>
        ...
        ///     <para>Must be GL.SYNC_GPU_COMMANDS_COMPLETE.</para>
        /// </param>
        ...
        /// <param name="flags">A bitfield controlling the command flushing behavior. flags may be GL.SYNC_FLUSH_COMMANDS_BIT.</param>
        /// <param name="timeout">
        ///     The timeout, specified in nanoseconds, for which the implementation should wait for sync to
        ///     become signaled.
        /// </param>
        /// <returns>The status, which will be GL.ALREADY_SIGNALED, GL.TIMEOUT_EXPIRED, GL.CONDITION_SATISFIED, or GL.WAIT_FAILED.</returns>
        ...
        /// </summary>
        /// <param name="target">Specifies the target texture.<para>Must be GL.TEXTURE_1D.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target texture.<para>Must be GL.TEXTURE_2D, GL.TEXTURE_CUBE_MAP_POSITIVE_X, GL.TEXTURE_CUBE_MAP_NEGATIVE_X, GL.TEXTURE_CUBE_MAP_POSITIVE_Y, GL.TEXTURE_CUBE_MAP_NEGATIVE_Y, GL.TEXTURE_CUBE_MAP_POSITIVE_Z, or GL.TEXTURE_CUBE_MAP_NEGATIVE_Z.</para></param>
        /// <param name="level">Specifies the level-of-detail number. Level 0 is the base image level. Level n is the nth mipmap reduction image.</param>
        /// <param name="internalFormat">Specifies the internal format of the texture.</param>
        ...
        ///     <para>
        ///         Must be GL.TEXTURE_1D_ARRAY, GL.TEXTURE_2D, GL.TEXTURE_CUBE_MAP_POSITIVE_X, GL.TEXTURE_CUBE_MAP_NEGATIVE_X,
        ...
        ///     <para>Must be GL.RED, GL.RG, GL.RGB, GL.BGR, GL.RGBA, GL.DEPTH_COMPONENT, or GL.STENCIL_INDEX.</para>
        /// </param>
        /// <param name="type">Specifies the data type of the pixel data.</param>
        /// <param name="pixels">Specifies a pointer to the image data in memory.</param>
        ...
        ///     <para>Must be GL.TEXTURE_3D, GL.TEXTURE_2D_ARRAY or GL.TEXTURE_CUBE_MAP_ARRAY.</para>
        /// </param>
        /// <param name="level">Specifies the level-of-detail number.
        ///     <para>Level 0 is the base image level. Level n is the nth mipmap reduction image.</para>
        /// </param>
        ...
        ///     <para>
        ///         GL.POINTS, GL.LINE_STRIP, GL.LINE_LOOP, GL.LINES, GL.LINE_STRIP_ADJACENCY, GL.LINES_ADJACENCY,
        ///         GL.TRIANGLE_STRIP, GL.TRIANGLE_FAN, GL.TRIANGLES, GL.TRIANGLE_STRIP_ADJACENCY, GL.TRIANGLES_ADJACENCY and
        ...
        ///     <para>The symbolic constant must be GL.READ_ONLY, GL.WRITE_ONLY, or GL.READ_WRITE.</para>
        /// </param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target texture.<para>Must be GL.TEXTURE_3D, GL.PROXY_TEXTURE_3D, GL.TEXTURE_2D_ARRAY or GL.PROXY_TEXTURE_2D_ARRAY.</para></param>
        /// <param name="level">Specifies the level-of-detail number. Level 0 is the base image level. Level n is the nth mipmap reduction image.</param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target texture.<para>Must be GL.TEXTURE_1D or GL.PROXY_TEXTURE_1D.</para></param>
        /// <param name="level">Specifies the level-of-detail number. Level 0 is the base image level. Level n is the nth mipmap reduction image.</param>
        /// <param name="internalFormat">Specifies the format of the compressed image data stored at address data.</param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target to which the texture is bound.<para>Must be GL.TEXTURE_2D_ARRAY, GL.TEXTURE_3D, or GL.TEXTURE_CUBE_MAP_ARRAY.</para></param>
        /// <param name="level">Specifies the level-of-detail number. Level 0 is the base image level. Level n is the nth mipmap reduction image.</param>
        /// <param name="xOffset">Specifies a texel offset in the x direction within the texture array.</param>
        /// <param name="yOffset">Specifies a texel offset in the y direction within the texture array.</param>
        ...
        ///     <para>
        ///         Must be one of GL.ATOMIC_COUNTER_BUFFER, GL.TRANSFORM_FEEDBACK_BUFFER, GL.UNIFORM_BUFFER, or
        ...
        /// <param name="target">Specify the counter to query. must be GL.TIMESTAMP.</param>
        ...
        /// </summary>
        /// <param name="type">Specifies the type of shader to be created.<para>Must be one of GL.VERTEX_SHADER, GL.GEOMETRY_SHADER, or GL.FRAGMENT_SHADER.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the framebuffer target. The symbolic constant must be GL.FRAMEBUFFER.</param>
        /// <param name="attachment">
        ///     Specifies the attachment point to which renderbuffer should be attached.
        ///     <para>
        ///         Must be one of the following symbolic constants: GL.COLOR_ATTACHMENT0, GL.DEPTH_ATTACHMENT, or
        ///         GL.STENCIL_ATTACHMENT.
        ///     </para>
        /// </param>
        /// <param name="renderbufferTarget">Specifies the renderbuffer target. The symbolic constant must be GL.RENDERBUFFER.</param>
        ...
        ///     <para>
        ///         Must be GL.DRAW_FRAMEBUFFER, GL.READ_FRAMEBUFFER, or GL.FRAMEBUFFER. GL.FRAMEBUFFER is equivalent to
        ///         GL.DRAW_FRAMEBUFFER.
        ///     </para>
        /// </param>
        /// <param name="attachment">
        ///     Specifies the attachment point of the framebuffer.
        ///     <para>Must be GL.COLOR_ATTACHMENTi, GL.DEPTH_ATTACHMENT, GL.STENCIL_ATTACHMENT or GL.DEPTH_STENCIL_ATTACHMENT.</para>
        /// </param>
        /// <param name="texture">
        ...
        /// <param name="mask">The bitwise OR of the flags indicating which buffers are to be copied.<para>The allowed flags are GL.COLOR_BUFFER_BIT, GL.DEPTH_BUFFER_BIT and GL.STENCIL_BUFFER_BIT.</para></param>
        /// <param name="filter">Specifies the interpolation to be applied if the image is stretched.<para>Must be GL.NEAREST or GL.LINEAR.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specify the target of the bind operation.<para>Must be GL.RENDERBUFFER.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target to which the texture object is bound.<para>Must be one of GL.TEXTURE_1D, GL.TEXTURE_2D, GL.TEXTURE_3D, GL.TEXTURE_1D_ARRAY, GL.TEXTURE_2D_ARRAY, GL.TEXTURE_CUBE_MAP, or GL.TEXTURE_CUBE_MAP_ARRAY.</para></param>
        ...
        /// </summary>
        /// <param name="paramName">Specifies a single-valued point parameter.<para>GL.POINT_FADE_THRESHOLD_SIZE, and GL.POINT_SPRITE_COORD_ORIGIN are accepted.</para></param>
        ...
        ///         one of GL.TEXTUREi, where i ranges from 0 to GL.MAX_TEXTURE_COORDS - 1, which is an implementation-dependent
        ///         value.
        ///     </para>
        /// </param>
        ...
        /// Set the current texture coordinates.
        /// </summary>
        /// <param name="type">Specifies the texture unit whose coordinates should be modified.<para>The number of texture units is implementation dependent, but must be at least two. Symbolic constant must be one of GL.TEXTUREi, where i ranges from 0 to GL.MAX_TEXTURE_COORDS - 1, which is an implementation-dependent value.</para></param>
        ...
        ///     <para>Must be 1, 2, 3, 4, or <see cref="GL.BGRA" />.</para>
        /// </param>
        ...
        ///     the data store of the buffer currently bound to the GL.ARRAY_BUFFER target.
        /// </param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target to which the texture is bound.<para>Must be GL.TEXTURE_BUFFER.</para></param>
        ...
        /// </summary>
        /// <param name="id">Specifies the name of a query object.</param>
        /// <param name="pname">Specifies the symbolic name of a query object parameter.<para>Accepted values are GL.QUERY_RESULT or GL.QUERY_RESULT_AVAILABLE.</para></param>
        ...
        /// </summary>
        /// <param name="shader">Specifies the shader object to be queried.</param>
        /// <param name="pname">Specifies the object parameter.<para>Must be GL.SHADER_TYPE, GL.DELETE_STATUS, GL.COMPILE_STATUS, GL.INFO_LOG_LENGTH, or GL.SHADER_SOURCE_LENGTH.</para></param>
        /// <param name="args">Returns the requested object parameter.</param>
        ...
        /// <param name="pname">Specifies the symbolic name of a query object target parameter.<para>Accepted values are GL.CURRENT_QUERY or GL.QUERY_COUNTER_BITS.</para></param>
        /// <param name="args">Returns the requested data.</param>
        ...
        /// </summary>
        /// <param name="index">Specifies the index of the generic vertex attribute to be modified.</param>
        /// <param name="size">Specifies the number of components per generic vertex attribute.<para>Must be 1, 2, 3, 4 or GL.BGRA.</para></param>
        /// <param name="type">Specifies the data type of each component in the array.</param>
        ...
        /// <param name="pointer">Specifies a offset of the first component of the first generic vertex attribute in the array in the data store of the buffer currently bound to the GL.ARRAY_BUFFER target.<para>The initial value is 0.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target of the operation.<para>Must be GL.TEXTURE_2D_MULTISAMPLE or GL.PROXY_TEXTURE_2D_MULTISAMPLE.</para></param>
        ...
        /// Establish the data storage, format, dimensions, and number of samples of a multisample texture's image
        /// </summary>
        /// <param name="target">Specifies the target of the operation.<para>Must be GL.TEXTURE_2D_MULTISAMPLE_ARRAY or GL.PROXY_TEXTURE_2D_MULTISAMPLE_ARRAY.</para></param>
        /// <param name="samples">The number of samples in the multisample texture's image.</param>
        /// <param name="internalformat">The internal format to be used to store the multisample texture's image.<para>Must specify a color-renderable, depth-renderable, or stencil-renderable format.</para></param>
        /// <param name="width">The width of the multisample texture's image, in texels.</param>
        /// <param name="height">The height of the multisample texture's image, in texels.</param>
        ...
        /// </summary>
        /// <param name="target">Specifies a binding target of the allocation.<para>Must be GL.RENDERBUFFER.</para></param>
        ...
        /// <param name="pname">Specifies the symbolic name of the generic vertex attribute parameter to be returned.<para>Must be GL.VERTEX_ATTRIB_ARRAY_POINTER.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target to which the buffer object is bound.</param>
        /// <param name="pname">Specifies the name of the pointer to be returned.<para>Must be GL.BUFFER_MAP_POINTER.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target buffer object.<para>Must be GL.ARRAY_BUFFER or GL.ELEMENT_ARRAY_BUFFER.</para></param>
        /// <param name="pname">Specifies the symbolic name of a buffer object parameter.<para>Must be GL.BUFFER_SIZE or GL.BUFFER_USAGE.</para></param>
        ...
        /// </summary>
        /// <param name="target">Specifies the target renderbuffer object.<para>Must be GL.RENDERBUFFER.</para></param>
        ...
        /// </summary>
        /// <param name="pname">Specifies the sample parameter name.<para>Must be GL.SAMPLE_POSITION.</para></param>
        ...
        /// <param name="mode">Specifies what kind of primitives to render.</param>
        /// <param name="count">Specifies the number of elements to be rendered.</param>
        /// <param name="type">Specifies the type of the values in indices.<para>Must be one of GL.UNSIGNED_BYTE, GL.UNSIGNED_SHORT, or GL.UNSIGNED_INT.</para></param>
        /// <param name="indices">Specifies a pointer to the location where the indices are stored.</param>
        /// <param name="instanceCount">Specifies the number of instances of the specified range of indices to be rendered.</param>
        ...
        /// <param name="bufferMode">Identifies the mode used to capture the varying variables when transform feedback is active.<para>ust be GL.INTERLEAVED_ATTRIBS or GL.SEPARATE_ATTRIBS.</para></param>
        ...
        public const uint _INVALID_INDEX = 0xFFFFFFFF;
